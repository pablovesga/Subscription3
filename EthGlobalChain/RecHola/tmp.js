...
var onCronTrigger = (runtime2) => {
  runtime2.log("Workflow triggered - Processing all recurring payment records");
...
--- Processing Record ID: ${recordId} ---`);
  ...
  runtime2.log(`
=== Summary ===`);
  runtime2.log(`Total Records Processed: ${allRecordIds.length}`);
  runtime2.log(`Payments Executed: ${executedPayments}`);
  return {
...
function executePayInstallment(runtime2, evmConfig, agreementId) {
  ...
  runtime2.log(`Report generated with signature`);
  ...
  runtime2.log("Transaction submitted, waiting for confirmation");
  const txHash = bytesToHex(writeReportResult.txHash || new Uint8Array(32));
  runtime2.log(`Payment transaction hash: ${txHash}`);
